...
local function createDropdown(name, buttons, yOffset)
...
createDropdown("Farm", {
    {Text = "Farm Placeholder", Func = function() return "Clicked!" end}
}, 50)
